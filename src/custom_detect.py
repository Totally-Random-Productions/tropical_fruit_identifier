...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_folder", type=str, default="data/temp", help="path to dataset")
    ...
    label_output = open("data/temp/output_labels.txt", "w")
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        if detections is None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                label_output.write("%d Image: '%s'" % (img_i, path))
                label_output.write("\tLabel: %s, Conf: %.5f\n" % (classes[int(cls_pred)], cls_conf.item()))
